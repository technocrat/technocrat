...
Keywords: large database, MySQL, Python, data wrangling, exploratory data analysis, data mining, linar regression, normality of residuals
...
### None of the quantitative variables can be used in regression for the pool as a whole
...
This eliminates *fico* as a candidate independent variable in any generalized linear regression model, including logistic regression.
...
With the possible exception of *orate*, which takes on discrete values and is a candidate for logistic regression, none of the quantitative variables can be used in any linear regression or logistic regression.
