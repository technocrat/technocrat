# Daycare Costs and Unexamined Assumptions
...
```{r setup3, include=TRUE, echo=FALSE, results= 'asis'}
library(knitr)
library(kableExtra)
library(readr)
library(scales)
...
```{r mhi, include=TRUE, echo=FALSE, results= 'asis'}
library(acs)
...
```{r mfi, include=TRUE, echo=FALSE, results= 'asis'}
...
```{r diff, include=TRUE, echo=FALSE, results= 'asis', message=FALSE}
